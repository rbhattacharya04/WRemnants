...
def build_graph(df, dataset):
    ...
    if args.useDileptonTriggerSelection:
        df = muon_selections.apply_triggermatching_muon(df, dataset, "trigMuons_eta0", "trigMuons_phi0", "nonTrigMuons_eta0", "nonTrigMuons_phi0",era)
    else:
        df = muon_selections.apply_triggermatching_muon(df, dataset, "trigMuons_eta0", "trigMuons_phi0",None, None, era)
